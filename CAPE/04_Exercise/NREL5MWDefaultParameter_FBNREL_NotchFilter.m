...
Parameter.Filter.LowPass.f_cutoff       = 3*12.1/60/100;      % [Hz] (cuando aplico un filtro pasa bajo se atrasa la respuesta y afecta la respuesta del controlador)

r_GB                                                    = 97;               % [-]
Parameter.Filter.DynamicNotchFilter1.Enable             = 1;                % [-]
Parameter.Filter.DynamicNotchFilter1.Gain        	    = 3/r_GB;           % [-]
Parameter.Filter.DynamicNotchFilter1.RelativeBandwidth  = 0.3;              % [-]
Parameter.Filter.DynamicNotchFilter1.Depth              = 0.1;              % [-] 
Parameter.Filter.LowPassDynamicNotchFilter.f_cutoff     = 0.02970;          % [Hz] 
