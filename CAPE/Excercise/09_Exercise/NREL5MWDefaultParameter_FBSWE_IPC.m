...
Parameter.Filter.LowPassDynamicNotchFilter.f_cutoff     = 0.0279;           % [Hz] % 0.7/2/pi/4

%% Individual Pitch Control
Parameter.IPC.kp                        = 0;                                % [rad/Nm]
Parameter.IPC.Ti                        = 0;                                % [s]    
Parameter.IPC.psi_offset                = 0;                                % [rad]
Parameter.IPC.theta_max                 = 0;                                % [rad]    
