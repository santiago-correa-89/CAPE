% -----------------------------
% Script: Compares a wind step simulation of the SLOW model to a FAST
% simulation.
...
% manual control 
theta                           = deg2rad(0);                           % constant pitch for 16 m/s TODO!!!
P_el_rated                      = 0;
Omega_g_rated                   = 0;
M_g                             = 0;                                    % constant torque for 16 m/s TODO!!!
...
P_el        = 0;                            % electrical power TODO!!! 

%% Processing FAST
OutputFile  = 'FAST/ConstantWind_16.out';
